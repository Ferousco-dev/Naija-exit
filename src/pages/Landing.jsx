...
const STEPS = [
  {
    n: "01",
    title: "Onboard",
    desc: "Name, country, savings, monthly rate. Two minutes flat.",
  },
  {
    n: "02",
    title: "Bayse Pulls Signals",
    desc: "Live political odds + crypto sentiment from Nigerian markets.",
  },
  {
    n: "03",
    title: "FX Engine Scans",
    desc: "Live ₦ rates + full 7-day movement trend.",
  },
  {
    n: "04",
    title: "Score Calculated",
    desc: "4-signal weighted algorithm → one number.",
  },
  {
    n: "05",
    title: "Action Plan Delivered",
    desc: "5 personalized steps. Exact. Specific. Ready to execute.",
  },
];
...
const FEATURES = [
  {
    icon: "◉",
    title: "Live Japa Score",
    desc: "0–100. Four live signals. Recalculates on every visit so you're never working off stale data.",
    hi: G,
  },
  {
    icon: "◈",
    title: "Bayse Intelligence",
    desc: "Nigerian prediction markets drive every signal. 2027 election odds, instability alerts, crypto timing.",
    hi: GOLD,
  },
  {
    icon: "⟲",
    title: "FX Timing Engine",
    desc: "7-day ₦ movement tracked daily. Get told when to convert — before the rate crashes.",
    hi: G,
  },
  {
    icon: "◆",
    title: "AI Action Plan",
    desc: "GPT-4o generates 5 steps built from your exact savings, destination cost, FX rate, and Bayse signal.",
    hi: GOLD,
  },
  {
    icon: "⌖",
    title: "Japa Runway",
    desc: "See the exact months until you're ready at your current savings velocity.",
    hi: G,
  },
  {
    icon: "◎",
    title: "Naija AI Chatbot",
    desc: "Context-aware. Knows your score, rate, country. Answer to 'Should I convert now?' — instant.",
    hi: GOLD,
  },
];
...
const PERSONAS = [
  {
    emoji: "💰",
    label: "The Saver",
    desc: "Saving for 1–2 years but has no idea if the amount is enough or when the right time to leave actually is.",
    need: "Japa Score + Runway",
  },
  {
    emoji: "💱",
    label: "The Converter",
    desc: "Ready to move money to USD but paralysed by fear of converting at exactly the wrong moment.",
    need: "FX Trend + Bayse Signal",
  },
  {
    emoji: "🗺️",
    label: "The Planner",
    desc: "Has a target country but no honest breakdown of what it really costs to survive the first three months.",
    need: "Relocation Cost Tracker",
  },
  {
    emoji: "📰",
    label: "The Anxious",
    desc: "Refreshes political news daily. Terrified the ₦ will crash before they're ready to leave.",
    need: "Political Risk Alert",
  },
];
...
export default function Landing() {
  ...
  const liveUsdRate = fxRates?.USD
    ? parseFloat(fxRates.USD).toLocaleString()
    : "Loading...";

  const liveTickerItems = [
    fxRates?.USD
      ? `₦ / USD  ${parseFloat(fxRates.USD).toLocaleString()}`
      : "₦ / USD  Loading...",
    ...TICKER_ITEMS,
  ];
  ...
  const sectionHead = (label, title, sub, labelColor = G) => (
    <div style={{ textAlign: "center", marginBottom: "64px" }}>
      ...
      >
        {title}
        <br />
        <span style={{ color: "hsl(240,4%,48%)", fontWeight: "400" }}>
          {sub}
        </span>
      </h2>
    </div>
    ...
    >
      ...
      >
        ...
        <div>
          ...
          >
            Your personalized Japa Score — powered by live FX rates, Bayse
            market signals, and AI — tells you if you're ready to relocate and
            exactly when to convert your Naira.
          </p>
        ...
        >
          ...
          >
            ...
            >
              Hold conversion. Increase monthly savings by ₦50K. Prioritize visa
              budget — only ₦120K short. Watch Bayse weekly.
            </p>
          </div>
      ...
      >
        <div
          style={{
            ...
            pointerEvents: "none",
            background:
              "radial-gradient(ellipse 60% 80% at 50% 50%, hsla(142,70%,45%,0.045), transparent)",
          }}
        />
        <StatCounter
          target={39}
          suffix="M+"
          label="Nigerians emigrated"
          sub="2017 — 2023"
          active={statsInView}
          duration={2000}
        />
        <StatCounter
          target={70}
          suffix="%+"
          label="Naira lost in value"
          sub="Since the 2022 currency float"
          active={statsInView}
          duration={1500}
        />
        <StatCounter
          target={67}
          suffix="%"
          label="First-year migrants"
          sub="face financial hardship abroad"
          active={statsInView}
          duration={1800}
        />
      </section>
      ...
      >
        {sectionHead(
          "The Reality",
          "The Blind Journey.",
          "And why it fails most Nigerians.",
        )}
        <div
          className="ne-prob-grid"
          style={{
            display: "grid",
        ...
        >
          {[
            {
              n: "01",
              title: "Convert Naira blindly",
              desc: "They convert savings to USD at whatever rate is available — often the worst possible moment.",
            },
            {
              n: "02",
              title: "Underestimate the real cost",
              desc: "Visa fees, flights, housing deposit, first month rent — the actual number is 3× what they budgeted.",
            },
            {
              n: "03",
              title: "Ignore political signals",
              desc: "₦ weakens fastest during instability. Nobody warns them to convert before the crash comes.",
            },
            {
              n: "04",
              title: "Arrive completely unprepared",
              desc: "First 3 months abroad are the hardest. No income yet. Savings run out. The crisis begins quietly.",
            },
          ].map((item, i) => (
            <div
              key={item.n}
      ...
      >
        <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
          {sectionHead(
            "The System",
            "Entirely AI-governed.",
            "From signal to action plan.",
          )}
          <div
            className="ne-steps-row"
            style={{ display: "flex", position: "relative" }}
          >
            {/* connector */}
            <div
              className="ne-steps-line"
              style={{
                position: "absolute",
                top: "20px",
                left: "calc(100% / 10)",
      ...
      >
        <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
          {sectionHead(
            "Who This Saves",
            "Every Nigerian planning to Japa",
            "deserves to do it with eyes wide open.",
            GOLD,
          )}
          <div
            className="ne-persona-grid"
            style={{
              display: "grid",
              gridTemplateColumns: "repeat(2,1fr)",
              gap: "20px",
          ...
          >
            {PERSONAS.map((p, i) => (
              ...
              >
                <div style={{ fontSize: "34px", lineHeight: 1, flexShrink: 0 }}>
                  {p.emoji}
                </div>
                <div>
                  <h3
      ...
      >
        <div
          style={{
            ...
            pointerEvents: "none",
            background:
              "radial-gradient(ellipse 75% 55% at 50% 50%, hsla(142,70%,45%,0.08) 0%, transparent 65%)",
          }}
        />
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
          ...
          >
            · Team Oracle · OAU Bayse Hackathon 2026
          </span>
        </div>
